    ...
    return (
        ...
        <Transition appear show={isOpen} as={Fragment}>
            ...
            <div className="fixed inset-0 overflow-y-auto">
                ...
                >
                    <Dialog.Panel className="w-full h-4/5 transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                    <div className="w-full h-full grid grid-cols-2 gap-x-4">
                        <div className="w-full h-full">
                            ...
                            <div className="mt-2 w-full h-full">
                                ...
                                <div className={`w-full ${currentFile && 'pt-2'}`}>
                                <input 
                                    className='w-full file:h-full bg-page-bg text-black rounded-md file:rounded-l-md file:bg-queens-blue file:px-4 file:py-2 file:text-sm file:font-medium file:text-white file:hover:bg-blue-400 file:focus:outline-none file:focus-visible:ring-2 file:focus-visible:ring-white file:focus-visible:ring-opacity-75'
                                    type='file'
                        ...
                        <div className='w-full h-full'>
                            ...
                            <div className="mt-2 w-full flex pb-2">
                                <input
